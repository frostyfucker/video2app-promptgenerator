...
### 2. Core Features
A detailed, numbered list of all the features described or implied in the video. For each feature, explain what it does and how the user might interact with it.
