...
export const RefreshIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M11.5 15.5 13 14l-1.5-1.5"></path>
        <path d="M8.5 8.5 7 10l1.5 1.5"></path>
...
export const WandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M12.07 14.5A2.5 2.5 0 0 0 9.5 12a2.5 2.5 0 0 0-2.57 2.5"></path>
        <path d="M15 10a2.5 2.5 0 0 0-5 0"></path>
        <path d="M15 4a2.5 2.5 0 0 0-5 0"></path>
        <path d="M3 22l9-9"></path>
        <path d="M21 2l-2 2"></path>
        <path d="m19 6-2 2"></path>
        <path d="m15 10-2 2"></path>
        <path d="m7 18 2-2"></path>
    </svg>
);
